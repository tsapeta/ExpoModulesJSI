...
let react = "React"
let RuntimeExecutorPath = "./expo/node_modules/react-native/ReactCommon/runtimeexecutor" // header only target
let CallInvokerPath = "./expo/node_modules/react-native/ReactCommon/callinvoker" // header only target
let ReactFBReactNativeSpecPath = "./expo/node_modules/react-native/React/FBReactNativeSpec" // generated
let FBLazyVectorPath = "./expo/node_modules/react-native/Libraries/FBLazyVector" // header only
let virtualViewPath = "./expo/node_modules/react-native/ReactCommon/react/renderer/components/virtualview" // header only
let virtualViewExperimentalPath = "./expo/node_modules/react-native/ReactCommon/react/renderer/components/virtualviewexperimental" // header only
...
let reactNativeDependencies = BinaryTarget(
  name: .reactNativeDependencies,
  path: "./expo/apps/bare-expo/ios/Pods/ReactNativeDependencies/framework/packages/react-native/ReactNativeDependencies.xcframework",
  searchPaths: ["./expo/apps/bare-expo/ios/Pods/ReactNativeDependencies/framework/packages/react-native/ReactNativeDependencies.xcframework/Headers"]
)
...
let hermesPrebuilt = BinaryTarget(
  ...
  path: "./expo/apps/bare-expo/ios/Pods/hermes-engine/destroot/Library/Frameworks/universal/hermesvm.xcframework",
  searchPaths: ["./expo/apps/bare-expo/ios/Pods/hermes-engine/destroot/include"]
)
...
let rctDeprecation = RNTarget(
  name: .rctDeprecation,
  path: "./expo/node_modules/react-native/ReactApple/Libraries/RCTFoundation/RCTDeprecation"
)
...
let yoga = RNTarget(
  name: .yoga,
  path: "./expo/node_modules/react-native/ReactCommon/yoga",
...
let reactOSCompat = RNTarget(
  name: .reactOSCompat,
  path: "./expo/node_modules/react-native/ReactCommon/oscompat"
)

let rctSwiftUI = RNTarget(
  name: .rctSwiftUI,
  path: "./expo/node_modules/react-native/ReactApple/RCTSwiftUI"
)

let rctSwiftUIWrapper = RNTarget(
  name: .rctSwiftUIWrapper,
  path: "./expo/node_modules/react-native/ReactApple/RCTSwiftUIWrapper",
...
let reactRendererConsistency = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/consistency"
)

// React-debug.podspec
let reactDebug = RNTarget(
  name: .reactDebug,
  path: "./expo/node_modules/react-native/ReactCommon/react/debug",
  dependencies: [.reactNativeDependencies]
)
/// React-jsi.podspec
let jsi = RNTarget(
  name: .jsi,
  path: "./expo/node_modules/react-native/ReactCommon/jsi",
...
let reactUtils = RNTarget(
  name: .reactUtils,
  path: "./expo/node_modules/react-native/ReactCommon/react/utils",
  searchPaths: ["./expo/node_modules/react-native/ReactCommon/react/utils/platform/ios"],
...
let reactFeatureFlags = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/featureflags",
  excludedPaths: ["tests"]
)
...
let reactPerfLogger = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/reactperflogger",
...
let logger = RNTarget(
  name: .logger,
  path: "./expo/node_modules/react-native/ReactCommon/logger",
...
let mapbuffer = RNTarget(
  name: .mapbuffer,
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/mapbuffer",
  excludedPaths: ["tests"],
...
let reactRendererDebug = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/debug",
  excludedPaths: ["tests"],
  dependencies: [.reactDebug, .reactNativeDependencies]
)
...
let reactRuntimeExecutor = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/runtimeexecutor/platform/ios",
...
let reactJsInspectorTracing = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jsinspector-modern/tracing",
  excludedPaths: ["tests"],
...
let reactJsInspectorNetwork = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jsinspector-modern/network",
  dependencies: [.reactNativeDependencies],
  defines: [
...
let reactJsInspector = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jsinspector-modern",
...
let reactCxxReact = RNTarget(
  name: .reactCxxReact,
  path: "./expo/node_modules/react-native/ReactCommon/cxxreact",
...
let reactJsiExecutor = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jsiexecutor",
  searchPaths: [
    "./expo/node_modules/react-native/ReactCommon"
  ],
...
let reactJsiTooling = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jsitooling",
...
let reactHermes = RNTarget(
  name: .reactHermes,
  path: "./expo/node_modules/react-native/ReactCommon/hermes",
...
let reactNetworking = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/networking",
  excludedPaths: ["tests"],
...
let reactPerformanceCdpMetrics = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/performance/cdpmetrics",
  excludedPaths: ["tests"],
...
let reactPerformanceTimeline = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/performance/timeline",
  excludedPaths: ["tests"],
...
let reactRuntimeScheduler = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/runtimescheduler",
  excludedPaths: ["tests"],
...
let reactTurboModuleBridging = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/bridging",
  excludedPaths: ["tests"],
...
let reactJsErrorHandler = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/jserrorhandler",
  excludedPaths: ["tests"],
...
let reactGraphicsApple = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/graphics/platform/ios",
...
let reactGraphics = RNTarget(
  name: .reactGraphics,
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/graphics",
...
let reactTurboModuleCore = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/core",
  searchPaths: [
    ReactFBReactNativeSpecPath,
    FBLazyVectorPath,
      CallInvokerPath,
    "./expo/node_modules/react-native/ReactCommon/react/nativemodule/core/platform/ios",
  ],
...
let reactTurboModuleCoreDefaults = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/defaults",
...
let reactTurboModuleCoreMicrotasks = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/microtasks",
...
let reactIdleCallbacksNativeModule = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/idlecallbacks",
  dependencies: [.reactNativeDependencies, .reactDebug, .reactFeatureFlags, .reactUtils, .reactPerfLogger, .reactCxxReact, .reactTurboModuleCore]
)
...
let reactWebPerformanceNativeModule = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/webperformance",
...
let reactIntersectionObserverNativeModule = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/intersectionobserver",
...
let reactFeatureflagsNativemodule = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/featureflags",
  dependencies: [.reactNativeDependencies, .reactDebug, .reactFeatureFlags, .reactUtils, .reactPerfLogger, .reactCxxReact, .reactTurboModuleCore]
)
...
let reactNativeModuleDom = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/nativemodule/dom",
...
let rctTypesafety = RNTarget(
  name: .rctTypesafety,
  path: "./expo/node_modules/react-native/Libraries/Typesafety",
...
let reactCoreRCTWebsocket = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/WebSocket",
...
let reactCoreModules = RNTarget(
  ...
  path: "./expo/node_modules/react-native/React/CoreModules",
...
let reactRuntime = RNTarget(
  name: .reactRuntime,
  path: "./expo/node_modules/react-native/ReactCommon/react/runtime",
...
let reactRuntimeApple = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/runtime/platform/ios",
...
let reactCore = RNTarget(
  name: .reactCore,
  path: "./expo/node_modules/react-native/React",
  searchPaths: [
    "./expo/node_modules/react-native/React/I18n",
    "./expo/node_modules/react-native/React/Profiler",
        "./expo/node_modules/react-native/React/WebSocket",
        "./expo/node_modules/react-native/React/Views",
        "./expo/node_modules/react-native/React/Base",
    "./expo/node_modules/react-native/ReactCommon/react/runtime/platform/ios", // explicit header search path to break circular dependency. RCTHost imports `RCTDefines.h` in ReactCore, ReacCore needs to import RCTHost
  ],
...
let reactFabric = RNTarget(
  name: .reactFabric,
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer",
  excludedPaths: [
    "animations/tests",
...
let reactFabricInputAccessory = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/inputaccessory",
...
let reactFabricModal = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/modal",
  excludedPaths: [
    "platform/android",
    "platform/cxx",
  ],
...
let reactFabricSwitch = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/switch/iosswitch",
...
let reactFabricSafeAreaView = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/safeareaview",
  dependencies: [.reactNativeDependencies, .reactCore, .reactJsiExecutor, .reactTurboModuleCore, .jsi, .logger, .reactDebug, .reactFeatureFlags, .reactUtils, .reactRuntimeScheduler, .reactCxxReact, .yoga, .reactRendererDebug, .reactGraphics, .reactFabric, .reactTurboModuleBridging]
)

let reactFabricTextLayoutManager = RNTarget(
  name: .reactFabricTextLayoutManager,
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/textlayoutmanager",
  excludedPaths: [
    "platform/android",
    "platform/cxx",
    "platform/windows",
...
let reactFabricText = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/text",
  excludedPaths: [
    "platform/android",
    "tests",
  ],
...
let reactFabricTextInput = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/textinput",
...
let reactFabricImage = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/image",
  excludedPaths: ["tests"],
...
let reactFabricUnimplementedView = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/components/unimplementedview",
  dependencies: [.reactNativeDependencies, .reactCore, .reactJsiExecutor, .reactTurboModuleCore, .jsi, .logger, .reactDebug, .reactFeatureFlags, .reactUtils, .reactRuntimeScheduler, .reactCxxReact, .yoga, .reactRendererDebug, .reactGraphics, .reactFabric, .reactTurboModuleBridging]
)
...
let reactRCTFabric = RNTarget(
  name: .reactRCTFabric,
  path: "./expo/node_modules/react-native/React/Fabric",
...
let reactImageManagerApple = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/imagemanager/platform/ios",
...
let reactImageManager = RNTarget(
  ...
  path: "./expo/node_modules/react-native/ReactCommon/react/renderer/imagemanager",
  excludedPaths: ["platform", "tests"],
...
let reactRCTAnimation = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/NativeAnimation",
...
let reactRCTImage = RNTarget(
  name: .reactRCTImage,
  path: "./expo/node_modules/react-native/Libraries/Image",
...
let reactRCTText = RNTarget(
  name: .reactRCTText,
  path: "./expo/node_modules/react-native/Libraries/Text",
...
let reactRCTBlob = RNTarget(
  name: .reactRCTBlob,
  path: "./expo/node_modules/react-native/Libraries/Blob",
...
let reactRCTNetwork = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/Network",
  dependencies: [.yoga, .jsi, .reactTurboModuleCore],
  defines: [
    CXXSetting.define("REACT_NATIVE_DEBUGGER_ENABLED", to: "1", .when(configuration: BuildConfiguration.debug)),
    CXXSetting.define("REACT_NATIVE_DEBUGGER_ENABLED_DEVONLY", to: "1", .when(configuration: BuildConfiguration.debug)),
...
let reactRCTVibration = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/Vibration",
...
let reactAppDelegate = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/AppDelegate",
...
let reactRCTLinking = RNTarget(
  ...
  path: "./expo/node_modules/react-native/Libraries/LinkingIOS",
...
let reactSettings = RNTarget(
  name: .reactSettings,
  path: "./expo/node_modules/react-native/Libraries/Settings",
...
let package = Package(
  ...
  dependencies: [
//    .package(url: "https://github.com/facebook/react-native", exact: "0.83.1"),
//    .package(path: "../expo/node_modules/react-native"),
  ],
